...
This version is not an Agent-automation release. The self-describing API,
delegated OAuth access, and optional Skill from v2.9 are integration surfaces;
they should not become the internal engine for desktop sync.
