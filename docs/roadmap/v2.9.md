...
> Status: Released in v2.9.0 on 2026-08-30
>
...
- All lint, type-checking, Node, Cloudflare, coverage, Docker smoke, and critical
  browser gates passed on the final release line.
- Realmroot production regression confirmed discovery, workspace-bound access,
  application and grant visibility, and authenticated grant activity tracking.
- Generic-controller and direct-upload acceptance results remain recorded in
  [Agent File Management Regression](../design/agent-file-management-regression.md).
