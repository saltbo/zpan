...
export function GlobalSearchBar() {
  ...
  return (
    <button
      ...
      className="flex h-9 min-w-0 max-w-[480px] flex-1 items-center gap-2 rounded-md border bg-muted/60 px-3 text-left text-sm text-muted-foreground opacity-60 disabled:cursor-not-allowed"
    >
