...
describe('useSiteOptions — option map extraction logic', () => {
  it('maps query data through useSiteOptions', () => {
    ...
    expect(useSiteOptions()).toEqual({
      ...
      defaultTeamQuota: DEFAULT_ORG_QUOTA,
