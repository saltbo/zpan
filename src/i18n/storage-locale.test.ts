...
const STORAGE_METERING_KEYS = [
  ...
  'storage.checkoutRedirectTitle',
  'storage.checkoutRedirectDescription',
  'storage.checkoutRedirectErrorTitle',
  'storage.checkoutRedirectBack',
  ...
  'storage.packageStorageQuota',
  'storage.packageTrafficQuota',
  'storage.packageValidity',
  'storage.packageNoExpiry',
