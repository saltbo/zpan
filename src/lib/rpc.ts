...
export const adminSiteInvitations = hc<AdminSiteInvitationsRoute>('/api/invitations', opts)
...
export const publicSiteInvitations = hc<PublicSiteInvitationsRoute>('/api/invitations', opts)
